...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.add_module('pool', nn.AvgPool3d(kernel_size=(2,2,1), stride=2))
...
class Densenet121(DenseNet):
    def __init__(self):
        super(Densenet121, self).__init__(32, (6, 12, 24, 15), 64)

# Initialize DenseNet169
class Densenet169(DenseNet):
    def __init__(self):
        super(Densenet169, self).__init__(32, (6, 12, 32, 32), 64)

# Initialize DenseNet201
class Densenet201(DenseNet):
    def __init__(self):
        super(Densenet201, self).__init__(32, (6, 12, 48, 32), 64)

# Initialize DenseNet161
class Densenet161(DenseNet):
    def __init__(self):
        super(Densenet161, self).__init__(48, (6, 12, 36, 24), 96)
