...
from mp.utils.generate_labels import generate_train_labels
...
from data_aug_test import augment_data_aug_blur_test
from data_aug_test import augment_data_aug_noise_test
from data_aug_test import augment_data_aug_motion_test
from data_aug_test import augment_data_aug_ghosting_test
from data_aug_test import augment_data_aug_spike_test
        ...
        try:
            ...
            if self.data_type == 'train':
                if not self.restore:
                    ...
                    augment_data_aug_blur(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_noise(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_motion(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_ghosting(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_spike(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                else:
                    augment_data_aug_blur(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_noise(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_motion(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_ghosting(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_spike(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                generate_train_labels(self.num_intensities, self.train_dataset_path, self.train_dataset_path, True) #NEW train_path -> train_dataset_path
                
            if self.data_type == 'test':
                #delete_images_and_labels(self.test_dataset_path)
                #delete_images_and_labels(self.test_without_fft_path)
                #augment_data_aug_blur_test(self.test_path, self.test_dataset_path, self.test_without_fft_path, img_size=(1, 60, 299, 299))
                augment_data_aug_noise_test(self.test_path, self.test_dataset_path, self.test_without_fft_path, img_size=(1, 60, 299, 299))
                #augment_data_aug_motion_test(self.test_path, self.test_dataset_path, self.test_without_fft_path, img_size=(1, 60, 299, 299))
                augment_data_aug_ghosting_test(self.test_path, self.test_dataset_path, self.test_without_fft_path, img_size=(1, 60, 299, 299))
                augment_data_aug_spike_test(self.test_path, self.test_dataset_path, self.test_without_fft_path, img_size=(1, 60, 299, 299))
                generate_train_labels(self.num_intensities, self.test_dataset_path, self.test_dataset_path) #NEW test_path -> test_dataset_path
            ...
            if self.data_type == 'all':
                ...
                if not self.restore:
                    delete_images_and_labels(self.train_dataset_path)
                    delete_images_and_labels(self.train_without_fft_path)
                    augment_data_aug_blur(self.train_path, self.train_dataset_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_noise(self.train_path, self.train_dataset_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_motion(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_ghosting(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                    augment_data_aug_spike(self.train_path, self.train_dataset_path, self.train_without_fft_path, img_size=(1, 60, 299, 299))
                else:
                ...
                delete_images_and_labels(self.test_dataset_path)
                delete_images_and_labels(self.test_without_fft_path)
                augment_data_aug_blur(self.test_path, self.test_dataset_path, img_size=(1, 60, 299, 299))
                augment_data_aug_noise(self.test_path, self.test_dataset_path, img_size=(1, 60, 299, 299))
                augment_data_aug_motion(self.test_path, self.test_dataset_path, self.test_without_fft_path, img_size=(1, 60, 299, 299))
                augment_data_aug_ghosting(self.test_path, self.test_dataset_path, self.test_without_fft_path, img_size=(1, 60, 299, 299))
                augment_data_aug_spike(self.test_path, self.test_dataset_path, self.test_without_fft_path, img_size=(1, 60, 299, 299))
                generate_train_labels(self.num_intensities, self.test_dataset_path, self.test_dataset_path) #NEW test_path -> test_dataset_path

            if self.data_type == 'segmentation':
                delete_images_and_labels(self.segmentation_path)
                augmentation_segmentation(self.train_path, self.segmentation_path, image_type = 'img', img_size=(1, 60, 299, 299))
                augmentation_segmentation(self.train_path, self.segmentation_path, image_type = 'seg', img_size=(1, 60, 299, 299))
