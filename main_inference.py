...
if __name__ == "__main__": 
    ...
    config = {'device': cuda, 'input_shape': (1, 10, 256, 256), 'augmentation': True, 'mode': 'inference',
              ...
              'train_on': 'mixed', 'data_augmented': True, 'restore': False, 'store_data': False, 'dataset_name':'Task'}
